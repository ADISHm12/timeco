...
//     e.preventDefault()
//     let checkoutAlert = document.getElementById("alert")
//     $.ajax({
//     url: '/placeOrder',
//     method: 'post',
...
// }
//     if(responseData.orderId){console.log(responseData.orderId)
//
//
//     var options = {
//     "key": "rzp_test_CiR2CrX4sA44LS", // Enter the Key ID generated from the Dashboard
//     "amount": responseData.amount, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
//     "currency": "INR",
//     "name": "TIMECO",
//     "description": "Test Transaction",
//     "image": "/img/logo/logo.png",
//     "order_id": responseData.orderId, //This is a sample Order ID. Pass the id obtained in the response of Step 1
